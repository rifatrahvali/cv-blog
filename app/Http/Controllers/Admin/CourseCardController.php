...
class CourseCardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.pages-admin.pages_course.page-index', compact('courseCards')); // Kayıtları görünüme gönderiyoruz
    }

    // Yeni kayıt ekleme formu
    public function create()
    {
        return view('pages.pages-admin.pages_course.page-create-edit', ['courseCard' => null]); // Boş bir modelle formu gösteriyoruz
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.pages-admin.pages_course.page-create-edit', compact('courseCard')); // Formu doldurulmuş modelle gönderiyoruz
    }
