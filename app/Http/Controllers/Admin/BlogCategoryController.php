...
class BlogCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('pages.pages-admin.pages_blog-category.page-index', compact('categories'));
    }

    public function create()
    {
        $categories = BlogCategory::all(); // Üst kategori seçimi için tüm kategorileri gönderiyoruz
        return view('pages.pages-admin.pages_blog-category.page-create-edit', compact('categories'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.pages-admin.pages_blog-category.page-create-edit', compact('category', 'categories'));
    }
