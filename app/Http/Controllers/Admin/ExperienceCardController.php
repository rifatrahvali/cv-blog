...
class ExperienceCardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.pages-admin.pages_experience.page-index', compact('experienceCards')); // Listeleme görünümüne verileri gönderiyoruz.
    }

    // Yeni deneyim kartı ekleme formu gösterimi.
    public function create()
    {
        return view('pages.pages-admin.pages_experience.page-create-edit', ['experienceCard' => null]); // Boş bir form için görünüm döndürülüyor.
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.pages-admin.pages_experience.page-create-edit', compact('experienceCard'));
    }
