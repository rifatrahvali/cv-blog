...
class LearnedFromEducationCardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.pages-admin.pages_learned-from-education.page-index', compact('learnedFromEducationCards')); // Görünümü yükle.
    }
    ...
    public function create()
    {
        ...
        return view('pages.pages-admin.pages_learned-from-education.page-create-edit', [
    ...
    public function edit($id)
    {
        ...
        return view('pages.pages-admin.pages_learned-from-education.page-create-edit', compact('learnedFromEducationCard', 'educationCards'));
    }
